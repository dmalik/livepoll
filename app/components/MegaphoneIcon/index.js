...
function MegaphoneIcon(props) {
  ...
  return (
    <svg  x="0px" y="0px"
	 width={props.size} height={props.size} viewBox="0 0 64 64" enable-background="new 0 0 64 64">
<g>
...
<g>
	<polygon points="18.589,60 10.538,60 18.068,40.638 19.932,41.362 13.462,58 17.411,58 27.126,40.514 28.874,41.486 	"/>
</g>
<g>
